package servicedesk.ws.base.em;
...
import servicedesk.core.base.em.domain.EventParameter;
...
import servicedesk.core.base.em.service.EventService;
...
public class EndPoint extends AbstractJDomPayloadEndpoint {
     ...
     */
    public static final String NAMESPACE_URI = "servicedesk.em.logging";
    /**
    ...
    public EndPoint() throws JDOMException {
        Namespace namespace = Namespace.getNamespace("servicedesk", NAMESPACE_URI);
        eventsExpression = XPath.newInstance("//servicedesk:event");
        eventsExpression.addNamespace(namespace);
        eventDateExpression = XPath.newInstance(".//servicedesk:date");
        eventDateExpression.addNamespace(namespace);
        subjectExpression = XPath.newInstance(".//servicedesk:subject");
        subjectExpression.addNamespace(namespace);
        typeExpression = XPath.newInstance(".//servicedesk:significance");
        typeExpression.addNamespace(namespace);
        categoryExpression = XPath.newInstance(".//servicedesk:category");
        categoryExpression.addNamespace(namespace);
        incidentExpression = XPath.newInstance(".//servicedesk:incident");
        incidentExpression.addNamespace(namespace);
        parametersExpression = XPath.newInstance(".//servicedesk:parameter");
        parametersExpression.addNamespace(namespace);
        parameterNameExpression = XPath.newInstance("servicedesk:name");
        parameterNameExpression.addNamespace(namespace);
        parameterValueExpression = XPath.newInstance("servicedesk:value");
    ...
    protected Element invokeInternal(Element requestElement) throws Exception {
        ...
        Element responseElement = new Element(ECHO_RESPONSE_LOCAL_NAME, "servicedesk", NAMESPACE_URI);
