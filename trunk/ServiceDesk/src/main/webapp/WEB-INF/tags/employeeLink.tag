...
<%@ attribute name="employee" required="true" description="Pracownika" type="sd.domain.Employee" %>
<%@ attribute name="label" description="Etykieta do wyswietlenia. Domyslnie imie i nazwisko" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>

<a href="<c:url value="/sd/employeeDetails?id=${employee.id}" />" class="standard_link">
<c:choose>
