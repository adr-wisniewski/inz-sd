...
<%@ attribute name="value" required="true" type="servicedesk.infrastructure.general.domain.HierarchicalDomainObject<? extends java.io.Serializable>" description="wartosc kontrolki" %>
