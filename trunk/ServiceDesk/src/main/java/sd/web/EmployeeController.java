...
import sd.util.CheckboxSelection;
...
public class EmployeeController {
	...
	public static final String EDIT_SUCCESS = "/sd/editEmployeeSuccess";
	
	public static final String SEARCH_ACTION = "/sd/searchEmployee";
	
	public static final String SEARCH_VIEW_NAME = "sd/searchEmployee";
	...
	public String details(ModelMap map, @RequestParam("id") Integer employeeId) {
		...
		return "sd/employeeDetails";
	}
	
	@RequestMapping(value = "/sd/editPrivileges", method = RequestMethod.POST)
