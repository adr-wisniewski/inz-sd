...
public class EmployeePickerController {
	 ...
	 */
	public static final String VIEW_NAME = "sd/employeePicker";
	/**
	 * Nazwa akcji do wyszukiwania pracownikow
	 */
	public static final String ACTION_NAME = "/sd/employeePicker";
	/**
	 * Nazwa akcji z dokonanym wyborem pracownika
	 */
	public static final String CHOOSE_ACTION_NAME = "/sd/employeePickerChoose";
	/**
	 * Nazwa widoku z dokonanym wyborem pracownika
	 */
	public static final String CHOOSE_VIEW_NAME = "sd/employeePickerChoose";
