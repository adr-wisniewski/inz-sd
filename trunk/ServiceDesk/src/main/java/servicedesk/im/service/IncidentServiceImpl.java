 ...
 * 
 */
package servicedesk.im.service;
...
import servicedesk.domain.HistoryAction;
import servicedesk.domain.HistoryActionType;
import servicedesk.domain.HistoryActions;
import servicedesk.domain.HistoryBuilder;
import servicedesk.event.service.GenericEventService;
import servicedesk.im.app.IncidentSearchCriteria;
import servicedesk.im.dao.IncidentCategoryDao;
import servicedesk.im.dao.IncidentDao;
import servicedesk.im.dao.IncidentHistoryDao;
