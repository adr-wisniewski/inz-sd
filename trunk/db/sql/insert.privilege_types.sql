...
insert into privilege_types(privilege_code, description) values('MENU_CN', 'Menu zarz¹dzania konfiguracj¹');
...
insert into privilege_types(privilege_code, description) values('CN_RLC_EDI', 'Edycja klas relacji');
insert into privilege_types(privilege_code, description) values('CN_RLC_DEL', 'Usuwanie klas relacji');

insert into privilege_types(privilege_code, description) values('CN_ATR_VIE', 'Przegl¹danie atrybutów klas');
insert into privilege_types(privilege_code, description) values('CN_ATR_ADD', 'Dodawanie atrybutów klas');
insert into privilege_types(privilege_code, description) values('CN_ATR_EDI', 'Edycja atrybutów klas');
insert into privilege_types(privilege_code, description) values('CN_ATR_DEL', 'Edycja atrybutów klas');
