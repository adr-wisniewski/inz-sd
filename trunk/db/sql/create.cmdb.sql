...
CREATE TRIGGER C2_ENTITIES_TRG BEFORE INSERT ON C2_ENTITIES 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF :NEW.ENTITY_ID IS NULL THEN
      SELECT C2_ENTITIES_SEQ.NEXTVAL INTO :NEW.ENTITY_ID FROM DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/

CREATE TRIGGER C2_CLASS_TRG BEFORE INSERT ON C2_CLASSES 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF :NEW.CLASS_ID IS NULL THEN
      SELECT C2_CLASS_SEQ.NEXTVAL INTO :NEW.CLASS_ID FROM DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
