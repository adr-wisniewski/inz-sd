...
insert into C2_CLASSES(CLASS_ID, VERSION, IS_ABSTRACT, NAME, DESCRIPTION) values(105, 0, 'N', 'Monitory LCD', 'Monitory LCD');
...
insert into C2_ITEM_CLASSES(CLASS_ID, PARENT_CLASS_ID) values(105, 104);