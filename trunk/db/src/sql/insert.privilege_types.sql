...
insert into privilege_types(privilege_code, description) values('CMDB_ITEM_VIEW', 'Przegl¹danie elementów konfiguracji');
insert into privilege_types(privilege_code, description) values('CMDB_ITEM_ADD', 'Dodawanie elementów konfiguracji');
insert into privilege_types(privilege_code, description) values('CMDB_ITEM_EDIT', 'Edycja elementów konfiguracji');
insert into privilege_types(privilege_code, description) values('CMDB_ITEM_DELETE', 'Usuwanie elementów konfiguracji');

insert into privilege_types(privilege_code, description) values('CMDB_RELATIONSHIP_VIEW', 'Przegl¹danie relacji elementów konfiguracji');
insert into privilege_types(privilege_code, description) values('CMDB_RELATIONSHIP_ADD', 'Dodawanie relacji elementów konfiguracji');
insert into privilege_types(privilege_code, description) values('CMDB_RELATIONSHIP_EDIT', 'Edycja relacji elementów konfiguracji');
insert into privilege_types(privilege_code, description) values('CMDB_RELATIONSHIP_DELETE', 'Usuwanie relacji elementów konfiguracji');

insert into privilege_types(privilege_code, description) values('CMDB_ITEMCLASS_VIEW', 'Przegl¹danie klas elementów');
insert into privilege_types(privilege_code, description) values('CMDB_ITEMCLASS_ADD', 'Dodawanie klas elementów');
insert into privilege_types(privilege_code, description) values('CMDB_ITEMCLASS_EDIT', 'Edycja klas elementów');
insert into privilege_types(privilege_code, description) values('CMDB_ITEMCLASS_DELETE', 'Usuwanie klas elementów');
...
insert into privilege_types(privilege_code, description) values('CMDB_ATTRIBUTE_VIEW', 'Przegl¹danie atrybutów klas');
insert into privilege_types(privilege_code, description) values('CMDB_ATTRIBUTE_ADD', 'Dodawanie atrybutów klas');
