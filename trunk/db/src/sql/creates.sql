...
, CAB_ID NUMBER(10) NOT NULL 
, ECAB_ID NUMBER(10) NOT NULL 
, EXECUTIVE_ID NUMBER(10) NOT NULL 
...
CREATE SEQUENCE SD.RFC_RESOLUTIONS_SEQ;

CREATE SEQUENCE SD.RFC_PRIORITIES_SEQ;

CREATE SEQUENCE SD.RFC_IMPACTS_SEQ;

CREATE SEQUENCE SD.RFC_CATEGORIES_SEQ;
